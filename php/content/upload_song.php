...
if (isset($_GET['change-song-id'])) {
    $song_record = getSongFromId($_GET['change-song-id'])[0];
...
<div class="upload-song-container">
    ...
    <div class="button-container">
        <button id="<?= isset($_GET['change-song-id']) ? 'update-song-button' : 'upload-song-button' ?>" data-song-id="<?= $_GET['change-song-id'] ?? '-1' ?>">
