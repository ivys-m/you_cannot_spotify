...
-- insert into playlists (name, fk_user_created_by) values ('fucks-playlist', 1);
-- insert into songs (song_path, fk_user_uploaded_by) values ('./fuck.mp3', 1);
-- insert into saved (user_id, playlist_id) values (1, 1);
-- insert into contains (playlist_id, song_id) values (1, 1);
